...
[ExecuteInEditMode] [RequireComponent(typeof(Light))] public class SquareSpotlight : MonoBehaviour { [SerializeField] private int textureSize = 128; [SerializeField] private float squareSize = 0.5f;
